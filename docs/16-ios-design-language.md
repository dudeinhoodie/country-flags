...
> **Поправка (2026-08-15).** Части этого документа о нативной хроме и
> системной светлой/тёмной теме отменены
> [ADR-012](adr/ADR-012-dark-scene-design-language.md): визуальный язык —
> тёмная сцена со стеклом, минимальная версия — iOS 26. Правила о флагах,
> токенах, доступности и «цвет — не единственный носитель» действуют
> по-прежнему.
